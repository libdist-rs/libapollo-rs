...
use types::synchs_rr::{Block, Certificate, GENESIS_BLOCK, Height, Replica, Storage, View, ClientMsg, ProtocolMsg, Propose};
use config::Node;
...
impl Context {
    pub fn new(
        ...
        c.cert_map.insert(GENESIS_BLOCK.hash.clone(), Arc::new(Certificate::empty_cert()));
        c
    }
